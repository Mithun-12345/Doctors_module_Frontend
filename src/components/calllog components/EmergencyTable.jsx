...
//     // 🔹 API 1 – patient + appointment data
//     let url = `${API_URL}/api/doctor/getAllAppointmentsWithPatientData`;
//     if (selectedFollowType === "View All") {
//       url = `${API_URL}/api/log/list?appointmentFixed=Yes`;
//     }

//     const patientResponse = await axios.get(url);

//     // 🔹 API 2 – appointment list (contains isEmergency)
...
//     console.log("Patient API:", patientResponse.data);
//     console.log("Appointment API:", appointmentResponse.data);

//     const patientData = Array.isArray(patientResponse.data)
//       ? patientResponse.data
//       : [];

//     const appointmentData = Array.isArray(appointmentResponse.data.appointments)
...
//       appointmentMap[a._id] = a.isEmergency;
//     });

//     // 🔥 Merge + filter emergency
//     const emergencyOnly = patientData.filter((p) => {
//       const isEmergency = appointmentMap[p.appointmentId || p._id];
...
//     const url = `${API_URL}/api/doctor/appointments`;

//     const response = await axios.get(url, {
//       headers: { Authorization: `Bearer ${token}` } // ✅ Auth
//     });

//     const appointments = response.data.success 
//       ? response.data.appointments 
//       : Array.isArray(response.data) ? response.data : [];

//     // ✅ Emergency only
//     const emergencyOnly = appointments.filter(a => a.isEmergency === tre);
//     setPatients(emergencyOnly);
//   } catch (error) {
//     console.error("Error:", error);
//     setError("Failed to load emergency appointments");
//   } finally {
//     setIsLoading(false);
//   }
// };
...
//      const fetchPatients = async () => {
//   try {
//     let url = `${API_URL}/api/assign/doctors`;
//     if (selectedFollowType === "View All") {
//       url = `${API_URL}/api/log/list?appointmentFixed=Yes`;
//     }
//     const response = await axios.get(url);
...
//     // Now filter for emergency
//     const emergencyOnly = appointmentList.filter(app => app.isEmergency === true);
//     setPatients(emergencyOnly);
//   } catch (error) {
//     console.error("Error fetching patients:", error);
//     setError(error.message);
